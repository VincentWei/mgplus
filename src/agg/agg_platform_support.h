...
namespace agg
{
    ...
    public:
        ...
        bool load_img_from_dc(unsigned idx, HDC hdc);
        bool load_img_from_bitmap(unsigned idx, PBITMAP pbmp);
        //--------------------------------------------------------------------
        ...
        /* return the minigui create dc.*/
        HDC  rbuf_dc();
        unsigned long rbuf_img_p(int idx);
